...
export default function Contact() {
  return (
    ...
    <div className="pointer-events-none absolute -right-32 -top-32 z-0 h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle,rgba(255,75,31,0.22)_0%,rgba(14,14,16,0)_70%)] blur-2xl" />
