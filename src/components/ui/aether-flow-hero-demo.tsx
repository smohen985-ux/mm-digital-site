...
/**
 * Standalone demo version of the "Aether Flow" particle hero.
 * Kept separate from components/ui/aether-flow-hero.tsx (the M&M-branded
 * production hero) so it doesn't affect the live homepage. Rendered at /demo.
 */
...
class Particle {
  ...
  update(ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement, mouse: MousePos) {
...
export default function AetherFlowHeroDemo({ className }: { className?: string }) {
  ...
  React.useEffect(() => {
    ...
    const mouse: MousePos = { x: null, y: null, radius: 200 };
