      ...
      <div className="container flex max-w-[720px] flex-col items-start text-left">
        ...
        <Reveal index={4} className="mt-12 flex w-full flex-wrap gap-4">
          {TEAM.map((m) => (
            <div
              key={m.name}
              className="max-w-[260px] flex-1 basis-[200px] rounded-[20px] border border-border bg-surface p-8 text-center transition-[border-color,transform] hover:-translate-y-1 hover:border-accent"
            >
