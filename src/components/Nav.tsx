...
export default function Nav() {
  ...
  return (
    <div className="sticky top-6 z-30 px-4">
      <header className="mx-auto max-w-[1160px] rounded-full border border-border bg-[rgba(20,20,22,0.75)] backdrop-blur-md">
        <div className="flex items-center justify-between py-2.5 pl-6 pr-2.5">
          ...
          <nav className="flex items-center gap-12">
            ...
            <a
              className="inline-flex items-center gap-2 rounded-full bg-pill px-7 py-[15px] text-sm font-semibold text-pillInk transition-transform hover:-translate-y-0.5 active:scale-[0.96]"
              href="#contact"
            >
              Contact Us
            </a>
      ...
      <div
        id="mobileMenu"
        className={`mx-auto mt-2 max-w-[1160px] overflow-hidden rounded-[20px] border border-border bg-[rgba(20,20,22,0.95)] backdrop-blur-md transition-[max-height,opacity] duration-300 min-[800px]:hidden ${
        ...
        <div className="flex flex-col px-4 pb-8 pt-4">
          {LINKS.map((l, i) => (
            <a
              ...
              className={`py-3.5 text-[15px] font-medium text-muted hover:text-ink ${
